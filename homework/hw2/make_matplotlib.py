...
# plt.legend()
# plt.title('time vs end effector position with joint space damping in nullspace of control task, kv=28, kvj=10')
...
plt.legend()
plt.title('time vs joint position with joint space damping in nullspace of control task, kv=28, kvj = 10')
